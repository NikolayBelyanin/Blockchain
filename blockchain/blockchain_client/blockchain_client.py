...
class Transaction:
    ...
    def __init__(self, sender_public_key, sender_private_key, recipient_public_key, amount, message):
...
def generate_transaction():
    ...
    if float(amount) <= min_amount:
        ...
        transaction = Transaction(sender_public_key, sender_private_key, recipient_public_key, amount, message)
